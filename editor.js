...
(function() {
        ...
        <div class="editor-toolbar" id="editor-toolbar">
          ...
          <div class="toolbar-group">
            ...
            <button class="tool-btn" data-command="insertOrderedList" title="Numbered List">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><text x="2" y="8" font-size="8" fill="currentColor">1.</text><line x1="16" y1="8" x2="22" y2="8" stroke="currentColor" stroke-width="2"/><text x="2" y="16" font-size="8" fill="currentColor">2.</text><line x1="16" y1="16" x2="22" y2="16" stroke="currentColor" stroke-width="2"/></svg>
            </button>
          </div>
          <div class="toolbar-separator"></div>
          <div class="toolbar-group">
  ...
  function init() {
    ...
    // NOTE: All editor styles are now handled by editor.css
    // No inline styles needed - this prevents conflicts with the stylesheet
  }
